module DesignSystem.Spacing exposing (SpacingSize(..), margin2, marginBottom, marginLeft, marginRight, marginTop, padding, padding2, paddingBottom, paddingLeft, paddingRight, paddingTop, spacing)
...
paddingBottom : SpacingSize -> Style
paddingBottom spacingSize =
    Css.paddingBottom (spacing spacingSize)
